        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                this.client.get(key, (error, data) => {
                    if (error)
                        reject(new redis_exception_1.RedisException(501, error === null || error === void 0 ? void 0 : error.message));
                    resolve(data);
                });
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                this.client.setex(key, timeout, value, (error) => {
                    if (error)
                        reject(new redis_exception_1.RedisException(501, error.message));
                    resolve();
                });
            });
        });
